...
@section('page-title', 'Add New Coordinator')
...
<div class="card">
    <div class="card-header">
        ...
        <p style="color: #6b7280; margin-top: 0.5rem;">Coordinator ID will be automatically generated in format: COO/{coordinator_number}</p>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.coordinators.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('coordinator_name') is-invalid @enderror" 
                           id="coordinator_name" name="coordinator_name" value="{{ old('coordinator_name') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nic_no') is-invalid @enderror" 
                           id="nic_no" name="nic_no" value="{{ old('nic_no') }}" required>
                    @error('nic_no')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <!-- Coordinator ID Preview -->
            <div id="coordinator-id-preview" style="background: #f8fafc; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem;">
                <h4 style="margin-bottom: 0.5rem; color: #374151;">Generated Coordinator ID:</h4>
                <div id="preview-id" style="font-family: monospace; font-size: 1.2rem; font-weight: bold; color: #1f2937;"></div>
                <small style="color: #6b7280;">Format: COO/{coordinator_number}</small>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const previewDiv = document.getElementById('coordinator-id-preview');
    ...
    previewId.textContent = `${prefix}/001`;
