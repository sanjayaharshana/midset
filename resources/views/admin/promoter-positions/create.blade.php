...
@section('title', 'Create Promoter Position')
@section('page-title', 'Add New Position')
...
<div class="card">
    <div class="card-header">
        ...
        <p style="color: #6b7280; margin-top: 0.5rem;">Create a new promoter position for your organization.</p>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.promoter-positions.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          placeholder="Optional description of the position, responsibilities, requirements, etc.">{{ old('description') }}</textarea>
