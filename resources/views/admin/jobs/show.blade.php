                    ...
                    <div style="display: grid; gap: 1rem;">
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                {{ $job->officer->name }}
                                <span style="color: #6b7280; font-size: 0.8rem; margin-left: 0.5rem;">({{ $job->officer->email }})</span>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                {{ $job->reporter->name }}
                                <span style="color: #6b7280; font-size: 0.8rem; margin-left: 0.5rem;">({{ $job->reporter->email }})</span>
                            </div>
                        </div>
                        @endif
                    </div>
